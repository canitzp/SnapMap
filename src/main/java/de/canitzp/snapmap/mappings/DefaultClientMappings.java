...
public class DefaultClientMappings extends MappingsBase {
    ...
    public boolean processMinecraftClass() {
        ...
        for (MethodNode method : methods) {
            for (AbstractInsnNode insn = method.instructions.getFirst(); insn != null; insn = insn.getNext()) {
                if (!DynamicMappings.isLdcWithString(insn, "Caught error stitching, removing all assigned resourcepacks"))
                    continue;
        ...
        if (methods.size() == 1) {
            ...
            if (fieldMap.size() == 6) {
                for (int n = 1; n <= 6; n++) {
                    switch (n) {
                        case 1:
                            addFieldMapping("net/minecraft/client/gui/GuiButton id I", guiButton.name + " " + fieldMap.get(n) + " I");
                            break;
                        case 2:
                            addFieldMapping("net/minecraft/client/gui/GuiButton xPosition I", guiButton.name + " " + fieldMap.get(n) + " I");
                            break;
                        case 3:
                            addFieldMapping("net/minecraft/client/gui/GuiButton yPosition I", guiButton.name + " " + fieldMap.get(n) + " I");
                            break;
                        case 4:
                            addFieldMapping("net/minecraft/client/gui/GuiButton width I", guiButton.name + " " + fieldMap.get(n) + " I");
                            break;
                        case 5:
                            addFieldMapping("net/minecraft/client/gui/GuiButton height I", guiButton.name + " " + fieldMap.get(n) + " I");
                            break;
                        case 6:
                            addFieldMapping("net/minecraft/client/gui/GuiButton displayString Ljava/lang/String;", guiButton.name + " " + fieldMap.get(n) + " Ljava/lang/String;");
                            break;
                    }
                }
            }
    ...
    public boolean processS2DPacketOpenWindowClass() {
        ...
        if (methods.size() == 1) {
            for (AbstractInsnNode insn = methods.get(0).instructions.getFirst(); insn != null; insn = insn.getNext()) {
                ...
                if (windowId != null && inventoryType != null && windowTitle != null && slotCount == null && fn.desc.equals("I")) {
                    slotCount = fn.name;
                    continue;
                }
            }
        ...
        if (methods.size() == 2) {
            ...
            for (MethodInsnNode mn : mnList1) {
                if (mn.desc.equals("(IIIIII)Z")) {
                    mousePressed.add(methods.get(0).name);
                    continue;
                } else if (mn.desc.equals("(IIIIII)V")) {
                    mouseReleased.add(methods.get(0).name);
                    continue;
                }
            }
            for (MethodInsnNode mn : mnList2) {
                if (mn.desc.equals("(IIIIII)Z")) {
                    mousePressed.add(methods.get(1).name);
                    continue;
                } else if (mn.desc.equals("(IIIIII)V")) {
                    mouseReleased.add(methods.get(1).name);
                    continue;
                }
            }
